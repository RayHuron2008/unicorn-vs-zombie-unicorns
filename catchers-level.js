// Level 6, revision 3: timed hunt, lasting paralysis, skippable dialogue, and fleeing birds.
...
(() => {
  function catchersRuntime() {
    ...
    function drawMech() {
      ...
      ctx.save(); ctx.translate(b.x, b.y - fall * 45 - (dancing ? Math.abs(Math.sin(beat)) * 13 : 0));
      ctx.rotate(-fall * 1.44 + (dancing ? Math.sin(beat * 0.5) * 0.09 : 0));
    ...
    draw = function() {
      ...
      if (hunt.phase === "intro") {
        dialogueBox(); text("PRESS A — NEXT TEXT", W / 2, H - 42, 18, "#f4dcac");
      }
