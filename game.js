  ...
  function cleanCodeInput(input, maxChars, addDash) {
   ...
   function startFirstLevelFromMultiplayer(levelCode, difficultyName) {
    ...
    const controls = document.getElementById("controls");
              ...
              if (!["RNBW1", "GRV2", "CITY3", "FRST5", "HUNT6", "RSCU7", "LAVA8", "LAKE9"].includes(finalLevelCode)) {
  alert("Use RNBW1, GRV2, CITY3, FRST5, HUNT6, RSCU7, LAVA8, or LAKE9.");
  return;
}
 ...
 function updateLobbyStatus() {
    ...
    joinCodeInput.addEventListener("input", () => {
      ...
      const difficultyName = hostDifficultySelect.value || "Easy";
            ...
            if (!["RNBW1", "GRV2", "CITY3", "FRST5", "HUNT6", "RSCU7", "LAVA8", "LAKE9"].includes(levelCode)) {
  alert("Use RNBW1, GRV2, CITY3, FRST5, HUNT6, RSCU7, LAVA8, or LAKE9.");
  return;
            }
...
if (window.__uvzuCurrentLevelCode === "VHS3") {
  // Daytime abandoned video store floor
  ctx.fillStyle = "#d8cfb5";
  ctx.fillRect(0, 0, W, H);

  // Checker-style worn floor tiles
  const tile = 48;
  ...
  // Main VHS aisles — Pac-Man-style maze
  const shelves = [
  ...
  player.webTrapY = player.y;
    ...
    if (
     ...
     window.__uvzuCurrentLevelCode = nextCode;
      window.__uvzuLevelTheme = nextCode === "GRV2" ? "graveyard" : nextCode === "CITY3" ? "downtown" : "rainbow";
